#!/usr/bin/env bash
#
# Source: https://gist.githubusercontent.com/0atman/1a5133b842f929ba4c1e195ee67599d5/raw/4e2f3ad34edb07843db9d6abb7c340bba611c07e/nixos-rebuild.sh
...
sudo nixos-rebuild switch --flake ~/Dotfiles-Nix#nixos --impure &>nixos-switch.log || (cat nixos-switch.log | grep --color error && exit 1)
